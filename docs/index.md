...
- Discover stories about visitor behaviour on opendata.scot by looking at our [site analytics data output](https://github.com/OpenDataScotland/opendata.scot_analytics) or in [browser version](https://opendata.scot/resources/siteanalytics/)
- Browse inspiring examples of [other projects using open data](https://opendata.scot/resources/odprojects/) both in Scotland and abroad
- Reference guides for [working with Scottish open data](https://opendata.scot/resources/workingwithod/)
